...
class UpdateConnectionRequestOptionsOneOf(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["client_id", "client_secret", "home_realm_domains", "entra_id_domain", "is_use_common_endpoint", "is_sync_user_profile_on_login", "is_retrieve_provider_user_groups", "is_extended_attributes_required", "is_create_missing_user", "is_force_show_sso_button", "upstream_params", "is_use_custom_domain", "is_trusted"]
