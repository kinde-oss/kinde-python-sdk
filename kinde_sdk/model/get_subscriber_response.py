...
class GetSubscriberResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class subscribers(
                ...
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['Subscriber'], typing.List['Subscriber']],
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["code", "message", "subscribers", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["code", "message", "subscribers", ], str]):
