...
class UserProfileV2(schemas.DictSchema):
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["provided_id"]
    ) -> MetaOapg.properties.provided_id:
        ...
    ...
    def get_item_oapg(
        self, name: typing_extensions.Literal["provided_id"]
    ) -> typing.Union[MetaOapg.properties.provided_id, schemas.Unset]:
        ...
    ...
    def __new__(
        ...
        *_args: typing.Union[
        ...
        provided_id: typing.Union[
            MetaOapg.properties.provided_id, None, str, schemas.Unset
        ] = schemas.unset,
        name: typing.Union[
        ...
        updated_at: typing.Union[
            MetaOapg.properties.updated_at, decimal.Decimal, int, schemas.Unset
        ] = schemas.unset,
        email: typing.Union[
