...
class UsersResponse(
            ...
            class users(
                ...
                class MetaOapg:
                    ...
                    class items(
                        ...
                        def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "provided_id", "email", "last_name", "first_name", "is_suspended", "picture", "total_sign_ins", "failed_sign_ins", "last_signed_in", "created_on", ], str]):
                        ...
                        def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "provided_id", "email", "last_name", "first_name", "is_suspended", "picture", "total_sign_ins", "failed_sign_ins", "last_signed_in", "created_on", ], str]):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["code", "message", "users", "next_token", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["code", "message", "users", "next_token", ], str]):
        return super().get_item_oapg(name)
