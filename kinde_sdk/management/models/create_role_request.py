...
class CreateRoleRequest(BaseModel):
    ...
    assignment_permission_id: Optional[UUID] = Field(default=None, description="The public ID of the permission required to assign this role to users. If null, no permission is required.")
