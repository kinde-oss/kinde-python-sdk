    ...
    def _register_kinde_routes(self) -> None:
        ...
        def callback():
            ...
            try:
                ...
                result = asyncio.run(self._oauth.handle_redirect(code, user_id, state))
        ...
        def logout():
            ...
            session.clear()
            logout_url = asyncio.run(self._oauth.logout(user_id))
        ...
        def register():
            ...
            register_url = asyncio.run(self._oauth.register())
