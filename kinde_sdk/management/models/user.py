...
class User(BaseModel):
    ...
    billing: Optional[UserBilling] = None
    __properties: ClassVar[List[str]] = ["id", "provided_id", "preferred_email", "phone", "username", "last_name", "first_name", "is_suspended", "picture", "total_sign_ins", "failed_sign_ins", "last_signed_in", "created_on", "organizations", "identities", "billing"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "billing": UserBilling.from_dict(obj["billing"]) if obj.get("billing") is not None else None
        })
        return _obj
