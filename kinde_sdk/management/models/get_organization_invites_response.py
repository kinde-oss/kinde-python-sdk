...
class GetOrganizationInvitesResponse(BaseModel):
    """
    ...
    invites: Optional[List[OrganizationInvite]] = None
    next_token: Optional[StrictStr] = Field(default=None, description="Pagination token.")
    __properties: ClassVar[List[str]] = ["code", "message", "invites", "next_token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetOrganizationInvitesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetOrganizationInvitesResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "invites": [OrganizationInvite.from_dict(_item) for _item in obj["invites"]] if obj.get("invites") is not None else None,
