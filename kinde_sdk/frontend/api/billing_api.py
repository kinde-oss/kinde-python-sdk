...
from kinde_sdk.frontend.api_client import ApiClient, RequestSerialized
from kinde_sdk.frontend.api_response import ApiResponse
from kinde_sdk.frontend.rest import RESTResponseType
...
class BillingApi:
    ...
    def get_entitlement(
        self,
        key: Annotated[StrictStr, Field(description="The key of the feature")],
        ...
        :param key: The key of the feature (required)
        :type key: str
    ...
    def get_entitlement_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetEntitlementResponse]:
        """Get entitlement
    ...
    def _get_entitlement_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/account_api/v1/entitlement',
