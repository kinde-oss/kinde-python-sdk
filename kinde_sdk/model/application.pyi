...
class Application(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["app_id", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["app_id", "name", ], str]):
