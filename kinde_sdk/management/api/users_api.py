...
class UsersApi:
    ...
    @validate_call
    def create_user_billing_customer(
        self,
        user_id: Annotated[StrictStr, Field(description="The user's ID.")],
        create_user_billing_customer_request: Annotated[CreateUserBillingCustomerRequest, Field(description="Billing customer details.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Creates a billing customer for a user in an organization, and assigns a published user billing plan.  This mirrors the admin \"Start billing customer\" action on the user billing page.  At most one billing customer is created per user in an organization. If one already exists, the request fails with `BILLING_CUSTOMER_EXISTS`. Concurrent creates that both pass the existence check before either finishes may both return success with the same customer and agreement ids (onboarding reuses the row created under the advisory lock).  <div>   <code>create:user_billing_customers</code> </div> 

        :param user_id: The user's ID. (required)
        :type user_id: str
        :param create_user_billing_customer_request: Billing customer details. (required)
        :type create_user_billing_customer_request: CreateUserBillingCustomerRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._create_user_billing_customer_serialize(
            user_id=user_id,
            create_user_billing_customer_request=create_user_billing_customer_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CreateUserBillingCustomerResponse",
            '400': "ErrorResponse",
            '403': "ErrorResponse",
            '429': "ErrorResponse",
        }
    ...
    @validate_call
    def create_user_billing_customer_with_http_info(
        self,
        user_id: Annotated[StrictStr, Field(description="The user's ID.")],
        create_user_billing_customer_request: Annotated[CreateUserBillingCustomerRequest, Field(description="Billing customer details.")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateUserBillingCustomerResponse]:
        """Create user billing customer
    ...
    @validate_call
    def create_user_billing_customer_without_preload_content(
        self,
        user_id: Annotated[StrictStr, Field(description="The user's ID.")],
        create_user_billing_customer_request: Annotated[CreateUserBillingCustomerRequest, Field(description="Billing customer details.")],
        _request_timeout: Union[
    ...
    def _create_user_billing_customer_serialize(
        self,
        user_id,
        create_user_billing_customer_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if create_user_billing_customer_request is not None:
            _body_params = create_user_billing_customer_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/users/{user_id}/billing_customer',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_user_data(
        self,
        id: Annotated[StrictStr, Field(description="The user's id.")],
        expand: Annotated[Optional[StrictStr], Field(description="Additional data to include in the response. One or more of (comma-separated): \"organizations\", \"identities\", \"billing\".")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: The user's id. (required)
        :type id: str
        :param expand: Additional data to include in the response. One or more of (comma-separated): \"organizations\", \"identities\", \"billing\".
        :type expand: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def update_user(
        ...
        Update a user record.  When `given_name` or `family_name` is updated and the user is the owner of a family billing customer, the change is also propagated to the corresponding billing customer details.  <div>   <code>update:users</code> </div> 
