...
from kinde_sdk.exceptions import ApiTypeError, ApiValueError, ApiException
from kinde_sdk.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_user  # this is an instance of the class Endpoint
        api_instance.get_user()  # this invokes api_instance.get_user.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_user.callable or self.callable in this class
