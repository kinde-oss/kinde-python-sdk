...
class GetRoleUsersResponse(BaseModel):
    ...
    users: Optional[List[GetRoleUsersResponseUsersInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetRoleUsersResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetRoleUsersResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "users": [GetRoleUsersResponseUsersInner.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None,
