...
class UserProfile(schemas.DictSchema):
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["preferred_email"]
    ) -> MetaOapg.properties.preferred_email:
        ...
    ...
    def get_item_oapg(
        self, name: typing_extensions.Literal["preferred_email"]
    ) -> typing.Union[MetaOapg.properties.preferred_email, schemas.Unset]:
        ...
    ...
    def __new__(
        ...
        *_args: typing.Union[
        ...
        preferred_email: typing.Union[
            MetaOapg.properties.preferred_email, str, schemas.Unset
        ] = schemas.unset,
