...
class GetPropertyValuesResponse(
        ...
        class properties:
            ...
            class properties(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['PropertyValue']:
                        return PropertyValue
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['PropertyValue'], typing.List['PropertyValue']],
                ...
                def __getitem__(self, i: int) -> 'PropertyValue':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["code", "message", "properties", "next_token", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["code", "message", "properties", "next_token", ], str]):
