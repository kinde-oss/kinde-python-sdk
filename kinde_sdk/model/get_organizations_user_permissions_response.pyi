...
class GetOrganizationsUserPermissionsResponse(
        ...
        class properties:
            ...
            class permissions(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['OrganizationUserPermission']:
                        return OrganizationUserPermission
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['OrganizationUserPermission'], typing.List['OrganizationUserPermission']],
                ...
                def __getitem__(self, i: int) -> 'OrganizationUserPermission':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["code", "message", "permissions", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["code", "message", "permissions", ], str]):
