...
class UsersResponseUsersInnerIdentitiesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "identity", "connection_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UsersResponseUsersInnerIdentitiesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UsersResponseUsersInnerIdentitiesInner from a dict"""
        if obj is None:
            return None
