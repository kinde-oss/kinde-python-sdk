...
class UpdateDirectoryResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["code", "message", "directory"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateDirectoryResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateDirectoryResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "directory": Directory.from_dict(obj["directory"]) if obj.get("directory") is not None else None
        })
        return _obj
