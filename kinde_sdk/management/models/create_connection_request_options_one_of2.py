...
class CreateConnectionRequestOptionsOneOf2(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["home_realm_domains", "saml_entity_id", "saml_idp_metadata_url", "saml_idp_metadata_xml", "saml_sign_in_url", "sign_request_algorithm", "protocol_binding", "name_id_format", "saml_email_key_attr", "saml_user_id_key_attr", "saml_first_name_key_attr", "saml_last_name_key_attr", "is_create_missing_user", "is_force_show_sso_button", "upstream_params", "saml_signing_certificate", "saml_signing_private_key", "is_auto_join_organization_enabled", "is_use_custom_domain", "is_trusted"]
