...
class GetDirectoriesResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["code", "message", "has_more", "directories"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "directories": [Directory.from_dict(_item) for _item in obj["directories"]] if obj.get("directories") is not None else None
        })
        return _obj
