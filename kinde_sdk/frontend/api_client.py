...
from kinde_sdk.frontend.api_response import ApiResponse, T as ApiResponseT
import kinde_sdk.frontend.models
from kinde_sdk.frontend import rest
from kinde_sdk.frontend.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(kinde_sdk.frontend.models, klass)
